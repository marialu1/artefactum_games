...
### 1.1 High Concept
A hybrid physical + digital cooperative investigation game where 4-10 players investigate the impossible simultaneous murder of three nuns in an isolated Portuguese orphanage. The investigation reveals supernatural vengeance by the spirits of abused children.

### 1.2 Core Experience
- **Genre:** Investigation / Murder Mystery / Horror
- **Tone:** Tense, morbid, unsettling, suspenseful
- **Format:** Self-running (no Game Master required)
- **Duration:** 2-3 hours (flexible)
- **Players:** 4-10 (sweet spot: 6-8)
- **Mode:** Fully cooperative

### 1.3 Unique Selling Points
- Physical box with locked compartments + companion app
- Evidence board building (cork board, pins, red string)
- Logical deduction leads to supernatural conclusion
- Dark Portuguese setting and themes
- AI-assisted development and potentially AI features in-game
...
├──────────────────────────────────────────────────────────────┤
│                                                              │
│  LAYER 0 - SETUP (Visible on opening)                        │
│  ├─ Cork board + pins + red string                           │
...
│  ├─ Sets the scene                                           │
│  ├─ Discovery of bodies                                      │
│  └─ Ends with QUESTION → answer unlocks Phase 1              │
│                                                              │
├──────────────────────────────────────────────────────────────┤
│                                                              │
│  PHASE 1 - CRIME SCENE (Physical, locked)                    │
│  ├─ Autopsy reports (3 nuns)                                 │
│  ├─ Crime scene notes                                        │
│  ├─ Crime scene photos                                       │
│  ├─ Physical evidence items                                  │
│  └─ Hidden clue → unlocks Phase 2                            │
│                                                              │
├──────────────────────────────────────────────────────────────┤
│                                                              │
│  PHASE 2 - TESTIMONIES (Physical, locked)                    │
│  ├─ Witness statements (nuns, orphans, staff)                │
│  ├─ Contradictory information                                │
│  ├─ First hints that nuns weren't pure                       │
│  └─ Code/clue → unlocks App Phase 3                          │
│                                                              │
├──────────────────────────────────────────────────────────────┤
│                                                              │
│  PHASE 3 - THE PAST (App/Digital)                            │
│  ├─ Historical records                                       │
│  ├─ Deaths of Miguel, Sofia, João                            │
│  ├─ The abuse revealed                                       │
│  └─ Clue → unlocks Phase 4                                   │
│                                                              │
├──────────────────────────────────────────────────────────────┤
│                                                              │
│  PHASE 4 - FINAL EVIDENCE (Physical, locked)                 │
│  ├─ Key evidence pieces                                      │
│  ├─ Beatriz (ex-orphan) connection                           │
│  ├─ Objects from the dead children                           │
│  └─ Everything needed for conclusion                         │
│                                                              │
├──────────────────────────────────────────────────────────────┤
│                                                              │
│  CONCLUSION (App)                                            │
...
#### LAYER 0 - SETUP
**Contents:**
- [ ] Cork board (size: TODO)
- [ ] Pins (quantity: TODO)
- [ ] Red string/yarn
- [ ] Orphanage floor plan (showing 3 crime locations)
- [ ] Timeline template (structure: TODO - empty? pre-filled dates?)
- [ ] Post-its (color: TODO)
- [ ] Marker
- [ ] QR code card → intro video

**Player Action:** Open box, set up investigation board, scan QR code

---

#### INTRO VIDEO
**Duration:** TODO (1:30 - 3:00 min?)
**Content:**
- [ ] Establish setting (orphanage, reputation, isolation)
- [ ] The discovery (who found bodies? when?)
- [ ] Brief overview of 3 deaths
- [ ] Player briefing (you are investigators)
- [ ] End with QUESTION

**Question to unlock Phase 1:**
- [ ] TODO: What is the question?
- [ ] TODO: What is the answer? (becomes lock code)

**Tone:** Dark, gothic, unsettling. News report? Police briefing?

---

#### PHASE 1 - CRIME SCENE
**Lock Type:** TODO (numeric? letter? what code?)
**Unlock Code:** Answer from intro video

**Contents:**
- [ ] Autopsy Report - Sister Beatriz (throat slit, 03:33 AM)
- [ ] Autopsy Report - Sister Teresa (drowned, 03:33 AM)
- [ ] Autopsy Report - Sister Leonor (hanged, 03:33 AM)
- [ ] Crime Scene Notes - Chapel
- [ ] Crime Scene Notes - Cistern/Garden
- [ ] Crime Scene Notes - 3rd Floor Dormitory
- [ ] Crime Scene Photos (quantity: TODO)
- [ ] Physical evidence for board (what exactly?: TODO)

**Key Information Revealed:**
- All 3 died at EXACTLY 03:33 AM (impossible for 1 person)
- Physical impossibilities (no weapon, child-sized handprints, 4m height)
- Strange objects at scenes (crucifix, doll, drawing - but origin unknown yet)
- Names mentioned but unexplained (sets up questions)

**Hidden Clue for Phase 2:**
- [ ] TODO: What is it?
- [ ] TODO: Where is it hidden?
- [ ] TODO: What code does it give?

---

#### PHASE 2 - TESTIMONIES
**Lock Type:** TODO
**Unlock Code:** From Phase 1

**Contents - Witness Statements:**
- [ ] Mother Superior - Sister Francisca (knows everything, hides everything)
- [ ] Sister Clara (music teacher, saw marks on children)
- [ ] Sister Mariana (kitchen assistant, knows about food deprivation)
- [ ] Sister Helena (librarian, knows secrets, speaks cryptically)
- [ ] Lucas, 17 (skeptic, saw shadow figure)
- [ ] Ana, 15 (sensitive, sees "Sofia")
- [ ] Pedro, 14 (found objects in attic)
- [ ] Matilde, 12 (traumatized, saw Leonor "pulled up")
- [ ] Other orphans (shorter statements)
- [ ] Manuel (caretaker, has keys, hostile)
- [ ] Rosa (cook, knows about reduced portions)
- [ ] Dr. António (did autopsies, saw marks before)
- [ ] Father Augusto (priest, speaks in riddles)

**Quantity of full testimonies:** TODO (all 13+? or selected?)

**Key Information Revealed:**
- Contradictions that are all technically true
- First hints nuns were abusers ("rigid discipline", marks, food deprivation)
- Strange phenomena (sounds after 21:00, shadow figures)
- Locked room impossibilities

**Hidden Clue for Phase 3 (App):**
- [ ] TODO: What unlocks the app section?

---

#### PHASE 3 - THE PAST (Digital)
**Unlock:** Code from Phase 2

**Contents:**
- [ ] Miguel's diary entries (2008)
- [ ] Medical reports - Sofia (2003 "accident")
- [ ] Medical reports - João (2010 "suicide")
- [ ] Old photographs (Miguel + Beatriz together)
- [ ] Records of "accidents" over the years
- [ ] João's drawings
- [ ] Possibly: video confession? CCTV footage? Audio?

**Key Information Revealed:**
- The 3 ghost children: who they were, how they died
- The nuns killed them / drove them to death
- Connection between ghost objects and crime scenes
- Hint about finding Beatriz (ex-orphan)

**Clue for Phase 4:**
- [ ] TODO: What unlocks final physical phase?

---

#### PHASE 4 - FINAL EVIDENCE
**Lock Type:** TODO
**Unlock Code:** From Phase 3

**Contents:**
- [ ] Beatriz's testimony/letter? (confirms everything)
- [ ] Original objects? (crucifix, doll, drawing - showing they belonged to dead children)
- [ ] Final connecting evidence
- [ ] TODO: What else?

**After this:** Players should have all pieces to conclude supernatural vengeance
...
**Duration:** TODO
**Content:**
- [ ] Confirms the supernatural truth?
- [ ] Shows flashbacks of the revenge killings?
- [ ] Emotional closure?
- [ ] Or leaves some ambiguity?

**Question:** Does video TELL them the answer or CONFIRM their deduction?

---

## 3. PUZZLE DESIGN

### 3.1 Lock/Code Summary
...
### 5.1 The Box
- [ ] Size: TODO
- [ ] Compartments: 4 locked sections + 1 open (setup)
- [ ] Material: TODO
- [ ] Design aesthetic: TODO (gothic? official police? aged?)

### 5.2 Locks
- [ ] Quantity: 3-4 physical locks
- [ ] Types: TODO (combination? key? directional?)
- [ ] Where to source: TODO

### 5.3 Cork Board
- [ ] Size: TODO (must fit in box but be usable)
- [ ] Included: pins, red string

### 5.4 Printed Materials
- [ ] Paper quality: TODO
- [ ] Aging/distressing: TODO (tea staining? burnt edges?)
- [ ] Fonts: TODO (period appropriate? official?)
- [ ] Total page count estimate: TODO

### 5.5 Props
- [ ] TODO: Any physical props beyond documents?
- [ ] Crucifix replica?
- [ ] Small doll?
...
## 6. NARRATIVE DOCUMENTS TO CREATE

### 6.1 Phase 1 Documents
| Document | Pages | Status |
|----------|-------|--------|
| Autopsy - Sr. Beatriz | TODO | Not started |
| Autopsy - Sr. Teresa | TODO | Not started |
| Autopsy - Sr. Leonor | TODO | Not started |
| Scene Notes - Chapel | TODO | Not started |
...
|----------|--------|--------|
| Miguel's Diary | Text/Images | Not started |
| Sofia's Medical Report | Text | Not started |
| João's Medical Report | Text | Not started |
| Old photographs | Images | Not started |
| João's drawings | Images | Not started |
| Accident records | Text | Not started |

### 6.4 Phase 4 Documents
| Document | Format | Status |
|----------|--------|--------|
...
## 7. ASSET LIST (Complete Inventory)

### 7.1 To Design/Create
- [ ] Orphanage floor plan
- [ ] Timeline template
- [ ] All printed documents (see Section 6)
- [ ] Crime scene photographs (create or source)
- [ ] Old photographs (1920s-2000s aesthetic)
- [ ] João's drawings
...
- [ ] Post-its
- [ ] Marker
- [ ] Optional props (crucifix, doll, etc.)
...
- [x] Game structure defined
- [ ] All TODO items in this GDD resolved
- [ ] Puzzle/code system fully designed
- [ ] Complete asset inventory

### Phase B: Narrative Creation
- [ ] All testimonies written
...
- [ ] Floor plan designed
- [ ] All documents formatted for print
- [ ] Photographs created/sourced
- [ ] Videos produced
- [ ] App developed
