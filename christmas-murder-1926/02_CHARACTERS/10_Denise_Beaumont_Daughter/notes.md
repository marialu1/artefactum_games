# Esmeralda Beaumont - Character Notes
...
- Born Jan 12, 1900 (twin sister: Claire)
...
- Reunited with Claire Nov 5, 1926 (life-changing)
- Discovered father's identity, tracked him down
- BLACKMAILED Reggie: $500 (Nov) + $300 (Dec) = $800 total
- Planned murder with Claire but DIDN'T EXECUTE IT
...
- **Nov 5, 1926:** Reunited with Claire (dramatic discovery)
...
- **Claire:** Twin sister (reunion Nov 5, complex dynamic: love + jealousy)
...
- Planned murder with Claire (but backed out)
...
- Twin confrontation scenes (dynamic with Claire)
